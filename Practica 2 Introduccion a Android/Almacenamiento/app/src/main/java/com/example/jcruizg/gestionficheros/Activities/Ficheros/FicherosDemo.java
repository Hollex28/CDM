...
public class FicherosDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        // PROPORCIONAR ALGO DE AYUDA INICIAL AL USUARIO
        //
        TextView tv = findViewById(R.id.tv_description);
        String msgDescriptivo = "Una pulsación larga en un elemento de la lista permite ahora editar o borrar el producto seleccionado. " +
                "Es posible configurar la app para recuperar la lista de la compra y almacenarla en memoria interna o memoria externa (SD).";

 ...
 *
 **********************************************************************************************************/
public class ProveedorDeDivisasPorHTTP extends ProveedorDeDivisasEnFormatoXML{
    //
    ...
    @Override
     public HashDivisas obtenerDivisas() {
        ...
        try {
            ...
            return super.obtenerDivisas_desdeString(retBuf.toString()); //RETORNAMOS UN STRING CON TODA LA INFORMACIÓN RECIBIDA
        }
    }

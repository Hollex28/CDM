...
.method protected containsAlphabetOrPad([B)Z
    ...
    invoke-virtual {p0, v0}, Lorg/apache/commons/codec/binary/BaseNCodec;->isInAlphabet(B)Z
...
.method public encode([B)[B
    ...
    .line 431
    .end local p1    # "pArray":[B
    :cond_0
    :goto_0
    return-object p1

    .restart local p1    # "pArray":[B
    :cond_1
    const/4 v0, 0x0
...
.method public encode([BII)[B
    ...
    invoke-virtual {p0, p1, p2, p3, v1}, Lorg/apache/commons/codec/binary/BaseNCodec;->encode([BIILorg/apache/commons/codec/binary/BaseNCodec$Context;)V

    .line 453
    const/4 v2, -0x1

    invoke-virtual {p0, p1, p2, v2, v1}, Lorg/apache/commons/codec/binary/BaseNCodec;->encode([BIILorg/apache/commons/codec/binary/BaseNCodec$Context;)V
    ...
    invoke-virtual {p0, v0, v2, v3, v1}, Lorg/apache/commons/codec/binary/BaseNCodec;->readResults([BIILorg/apache/commons/codec/binary/BaseNCodec$Context;)I
...
.method public isInAlphabet([BZ)Z
    ...
    .line 488
    invoke-static {v0}, Lorg/apache/commons/codec/binary/BaseNCodec;->isWhiteSpace(B)Z

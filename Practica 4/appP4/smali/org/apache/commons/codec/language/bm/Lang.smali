...
.method static constructor <clinit>()V
    ...
    const-class v3, Lorg/apache/commons/codec/language/bm/NameType;
    ...
    .local v0, "s":Lorg/apache/commons/codec/language/bm/NameType;
    :goto_0
    if-ge v1, v4, :cond_0
    ...
    invoke-virtual {v0}, Lorg/apache/commons/codec/language/bm/NameType;->getName()Ljava/lang/String;
    ...
    invoke-static {v0}, Lorg/apache/commons/codec/language/bm/Languages;->getInstance(Lorg/apache/commons/codec/language/bm/NameType;)Lorg/apache/commons/codec/language/bm/Languages;
...
.method public static loadFromResource(Ljava/lang/String;Lorg/apache/commons/codec/language/bm/Languages;)Lorg/apache/commons/codec/language/bm/Lang;
    ...
    const-string/jumbo v12, "Unable to resolve required resource:org/apache/commons/codec/language/bm/%s_lang.txt"
    ...
    const-string/jumbo v13, "Malformed line \'"
    ...
    const-string/jumbo v13, "\' in language resource \'"
...
.method public guessLanguages(Ljava/lang/String;)Lorg/apache/commons/codec/language/bm/Languages$LanguageSet;
    ...
    iget-object v4, p0, Lorg/apache/commons/codec/language/bm/Lang;->languages:Lorg/apache/commons/codec/language/bm/Languages;

    invoke-virtual {v4}, Lorg/apache/commons/codec/language/bm/Languages;->getLanguages()Ljava/util/Set;
    ...
    .line 218
    .local v0, "langs":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    iget-object v4, p0, Lorg/apache/commons/codec/language/bm/Lang;->rules:Ljava/util/List;
    ...
    .line 219
    .local v2, "rule":Lorg/apache/commons/codec/language/bm/Lang$LangRule;
    invoke-virtual {v2, v3}, Lorg/apache/commons/codec/language/bm/Lang$LangRule;->matches(Ljava/lang/String;)Z
    ...
    .line 228
    .end local v2    # "rule":Lorg/apache/commons/codec/language/bm/Lang$LangRule;
    :cond_2
    ...
    .line 229
    .local v1, "ls":Lorg/apache/commons/codec/language/bm/Languages$LanguageSet;
    ...
    .end local v1    # "ls":Lorg/apache/commons/codec/language/bm/Languages$LanguageSet;
    :cond_3
    return-object v1
.end method
